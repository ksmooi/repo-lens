...
---
repo: <owner>/<repo>
file: <README | 1-architecture | 2-code-walkthrough | 3-key-patterns | 9-questions>
studied_at: <YYYY-MM-DD>
commit_sha: <前 7 碼,例 a3f4b2c>
---
```

`README.md` 可額外加(由 agent 在 Step 1 metadata 中已取得的值):
...
## 三個最重要的發現
(從 3-key-patterns.md 中挑 3 個最值得的,各 1-2 句總結)
